...
{
    // Define 'owner'
    // address payable owner; --> inherited from Ownable
    ...
    struct Item {
        ...
        address payable ownerID; // Metamask-Ethereum address payable of the current owner as the product moves through 8 stages
        address payable originFarmerID; // Metamask-Ethereum address payable of the Farmer
        ...
        address payable distributorID; // Metamask-Ethereum address payable of the Distributor
        address payable retailerID; // Metamask-Ethereum address payable of the Retailer
        address payable consumerID; // Metamask-Ethereum address payable of the Consumer
    }
    ...
    // In the constructor set 'owner' to the address payable that instantiated the contract
    // and set 'sku' to 1
    // and set 'upc' to 1
